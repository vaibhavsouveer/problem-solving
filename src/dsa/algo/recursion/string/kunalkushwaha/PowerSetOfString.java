...
public class PowerSetOfString {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Power set list = " + funList(input, input.length(), "", new ArrayList<>()));
    }
    ...
    private static ArrayList<String> funList(String input, int n, String output, ArrayList<String> list) {
        if(n == 0) {
            list.add(output);
            //return list;
            // because we are not saving this list anywhere, what list is returned does not matter
            // we are already adding elements in list parameter
