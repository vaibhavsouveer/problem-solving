package dsa.algo.dp.adityaverma.knapsack.minimumsubsetsumdifference.bottomup;
...
public class MinSubSetSumDiffBottomUp {
    ...
    public static int minSubSetSumDiff(int[] arr, int n, int S) {
        ...
        // or we can find the last true value in half elements
        ...
        return minSumDiff;
        // similarly if we have to find max diff sub sets, we should find
        // first true value in half elements of last row of t matrix
    }
}
